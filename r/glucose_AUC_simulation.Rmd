...
simulate_it <- function(n=5, mu, beta, alpha, Sigma, times, niter=1000, method_list){
...
if(do_it == TRUE){
  ...
  res <- data.table(NULL)
  method_list <- c("lm_area", "lm_base", "lm_cov", "lm_mean", "lm_mean_change", "lm_mean_cov", "lm_mean_cov_alpha", "multi_t",  "rmanova", "clda", "lda_cov", "obrien", "roast")
  ...
  #   cor_models
  # )
  #res0 <- rbind(res, data.table(effect_model="no pre", res0))
